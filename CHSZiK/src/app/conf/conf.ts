...
export const CREATETYPESPAREPART_URL = BASE_URL + '/api/create_type_part'
export const GETTYPESPAREPARTS_URL = BASE_URL + '/api/type_parts?group_id='
export const GETTYPESPAREPART_URL = BASE_URL + '/api/type_part?id='
export const DELETETYPESPAREPARTS_URL = BASE_URL + '/api/delete_type_part?id='
export const CREATESPAREPART_URL = BASE_URL + '/api/create_part'
export const GETSPAREPART_URL = BASE_URL + '/api/parts?type_parts_id='
export const CHANGETYPESPAREPART_URL = BASE_URL + '/api/change_type_part'
export const GETGROUPSPAREPART_URL = BASE_URL + '/api/group'
export const CREATEWAREHOUSEGROUP_URL = BASE_URL + '/api/create_group'
export const GETGROUPSINWAREHOUSE_URL = BASE_URL + '/api/groups'
export const GETGROUPWAREHOUSE_URL = BASE_URL + '/api/group?group_id='
export const DELETEGROUPINWAREHOUSE_URL = BASE_URL + '/api/delete_group?id='
